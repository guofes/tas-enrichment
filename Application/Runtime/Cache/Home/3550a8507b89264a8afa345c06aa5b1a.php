...
<head>
    ...
    <!-- 网站ICON -->
    <link rel = "Shortcut Icon" href="/julei-11-28/Public/image/yu.ico"> 
    <!-- 引入样式文件 style.css  -->
    ...
    <script src="/julei-11-28/Public/js/echarts.min.js"></script>
    <script type="text/javascript" src="/julei-11-28/Public/multiselect/jquery-ui.js"></script>  
    <script type="text/javascript" src="/julei-11-28/Public/multiselect/jquery.multiselect.js"></script>   
    <link rel="stylesheet" type="text/css" href="/julei-11-28/Public/multiselect/jquery-ui.css">
    <link rel="stylesheet" type="text/css" href="/julei-11-28/Public/multiselect/jquery.multiselect.css">
    <style type="text/css">
        ...
        <div class="main-genes">
            ...
            <div class="gene-tab">
                <div class="all">
                    ...
                    <div id="tab-content1">
                        <img id="smallpic" src="/julei-11-28/Public/image/allmodule.png" >
                    </div>
...
<script src="/julei-11-28/Public/js/download_excel.js"></script>
<script src="/julei-11-28/Public/js/analysis.js"></script>
</html>