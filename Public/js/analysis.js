    ...
    function isshow(){ 
        if(icount == 3){
            ...
            $('#tab-content1').append(
                ...
                "<tr><th>&nbsp Type &nbsp </th><th>Enrichment information(Co-expression)</th>"+
"<th>Example of Terms(Modules)</th><th>Details informations</th></tr>"+
    
                "<tr class='tr_td'><td> &nbsp TO &nbsp </td><td class = 'enrich'><a onclick=$(\'#tab2\').click(); >"+"enriched in"+" " + countda2 +" " + "terms"+"</a></td>"+
                "<td><a class='nowrap'>"+ down1[6][0]+"...</a></td><td><a class='botton_download' id='TO_link'>links</a></td></tr>"+
    
                "<tr class='tr_td'><td>GO</td><td class = 'enrich'><a onclick=$(\'#tab3\').click();>"+"enriched in"+" " + countda3 +" " + "terms"+"</a></td>"+
                "<td><a class='nowrap' onclick=$(\'#tab3\').click()>"+ down2[6][0]+"...</a></td><td><a class='botton_download' id='GO_link'>links</a></td></tr>"+
    
                "<tr class='tr_td'><td>PC</td><td class = 'enrich'><a onclick=$(\'#tab4\').click();>"+"enriched in"+" " + countda4 +" " + "terms"+"</a></td>"+
                "<td><a class='nowrap' onclick=$(\'#tab4\').click()>"+ down3[6][0]+"...</a></td><td><a class='botton_download' id='PC_link'>links</a></td></tr>"+
    
                "<tr class='tr_td'><td>CO</td><td class = 'enrich'><a onclick=$(\'#tab5\').click()>Included "+
                 enrichCo 
                ...
                "</table>"+
                "<a class='genes-down-button' href='../Genes/download.html'>Total TO, GO, PC and CO's information link</a>"
        );
        get_table(countda2,down1,'to','tab-content2');
        get_table(countda3,down2,'go','tab-content3');
        get_table(countda4,down3,'pc','tab-content4');
        ...
        $(".enrich").each(function(){
            ...
            $("#TO_link").click(function(){
                ...
                $.ajax({
                    ...
                    type: 'post',
                    data: {down1:down1,name:"TO_link__"},
                    success: function(data){
            ...
            $("#GO_link").click(function(){
                if(countda3==0){
                    ...
                    $.ajax({
                        url: '../Analysis/un_download.html',
                        type: 'post',
                        data: {down1:down2,name:"GO_link__"},
                        success: function(data){
                            document.getElementById("unLink").click();
                        }
                    });
            ...
            $("#PC_link").click(function(){
                if(countda4==0){
                    ...
                    $.ajax({
                        url: '../Analysis/un_download.html',
                        type: 'post',
                        data: {down1:down3,name:"PC_link__"},
                        success: function(data){
                            document.getElementById("unLink").click();
                        }
                    });
    ...
    function get_table(a,b,name,table_name){
        if(a>0){
        $("#"+table_name).append(
            "<table id='"+name+"'>"+
                 " <th>test_yes</th>"+
...
function axisAjax(){ 
        ...
        // });
          $('#tab-content2').prepend("<a class='download-link' href='"+img.src+"' target='blank' >click here to see HD map !</a>");
        }
        isshow();
                }
            });
        ...
        for(var i=0;i<da['t'].length;i++){
            ...
            // down2[8].push(da['h'][i]/da['s']);
            // down2[9].push(da['t'][i]/da['r']);
            }
            }
            console.log(countda3);
        if(data_31.length==0){
        ...
        img.src = Chart3.getDataURL({
          ...
          $('#tab-content3').prepend("<a class='download-link' href='"+img.src+"' target='blank'>click here to see HD map !</a>");
        }
        ...
        success: function(datat){
            ...
            for(var i=0;i<da['TO_ID'].length;i++){
                ...
                // down3[8].push(da['h'][i]/da['s']);
                // down3[9].push(da['t'][i]/da['r']);
                }
            }  
        ...
        img.src = Chart4.getDataURL({
          ...
          $('#tab-content4').prepend("<a class='download-link' href='"+img.src+"' target='blank' >click here to see HD map !</a>");              
        } 
        isshow();
        }
        });   
      ...
      var gene = []; //返回的基因列表     
          ...
          function printLine(co_gene, newDotPoint, ajaxData){ 
             ...
             option = {
              ...
              $('#tab-content5').prepend("<a class='download-link' href='"+img.src+"' target='blank'>click here to see HD map !</a>");
